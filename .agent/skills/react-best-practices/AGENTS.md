...
1. [Eliminating Waterfalls](#1-eliminating-waterfalls) — **CRITICAL**
   ...
   - 1.3 [Prevent Waterfall Chains in Route Handlers](#13-prevent-waterfall-chains-in-route-handlers)
...
4. [Re-render Optimization](#4-re-render-optimization) — **MEDIUM**
   ...
   - 4.9 [Subscribe to Derived State](#49-subscribe-to-derived-state)
   - 4.10 [Use Functional setState Updates](#410-use-functional-setstate-updates)
   - 4.11 [Use Lazy State Initialization](#411-use-lazy-state-initialization)
   - 4.12 [Use Transitions for Non-Urgent Updates](#412-use-transitions-for-non-urgent-updates)
   - 4.13 [Use useRef for Transient Values](#413-use-useref-for-transient-values)
...
### 1.3 Prevent Waterfall Chains in Route Handlers

**Impact: CRITICAL (2-10× improvement)**

In route handlers and API handlers, start independent operations immediately, even if you don't await them yet.
...
### 4.13 Use useRef for Transient Values
